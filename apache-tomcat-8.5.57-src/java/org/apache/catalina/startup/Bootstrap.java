...
//启动类加载器，应用构造了一个类加载器用于加载catalina.home 下的jar文件，正常执行该容器，
...
public final class Bootstrap {
    ...
    //只有bin和lib目录能被多个tomcat实例公用，于是我们把这两个目录的父级目录叫做安装目录，并用catalina.home来表示。
    //被tomcat实例所私有的目录为：conf，logs，temp，webapps，work。于是我们把这些目录的父级目录叫做工作目录，并用catalina.base来表示
